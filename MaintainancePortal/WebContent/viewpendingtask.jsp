...
<div id="wrapper">
	...
	try
	{
		...
		PreparedStatement ps2=con.prepareStatement("select * from complaints where status=? and department=?");
		ps2.setString(1,"pending");
		ps2.setString(2,DeptGetSet.getDeptname());
