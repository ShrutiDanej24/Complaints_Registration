            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
							<a href="viewallcomplain.jsp" class="active"><i class="fa fa-home nav_icon"></i>View Compaints</a>
						</li>
	     ...
	     <div class="xs">
  	       <h3>Add Road Maintainance</h3>
  	         <div class="tab-content">
						...
						<form    action="AddRoadMain" method="post" >
 		
  <div class="form-group"><label for="exampleInputEmail1">Road Name</label>
<input type="text" class="form-control" id="exampleInputEmail1"   name="RName"  placeholder="Enter Name">
  </div>
  
  <div class="form-group">
    <label for="exampleInputPassword1">Road Location</label>
    <input type="text" class="form-control" id="exampleInputPassword1"  name="Location" placeholder="location">
  </div>
  
  
  <div class="form-group">
    <label for="exampleInputPassword1">Road Deadline Date</label>
    <input type="Date" class="form-control" id="exampleInputPassword1" name="Deadline" placeholder="Date">
  </div>
